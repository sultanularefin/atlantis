...
export interface Decrement_Btn_Home_Page_Props{
...
const Decrement_Btn_Home_Page: React.FC<Decrement_Btn_Home_Page_Props> = (
    {
        comp_Height_2,
        btn_Pressed,
        comp_Width,
...
export default Decrement_Btn_Home_Page;
