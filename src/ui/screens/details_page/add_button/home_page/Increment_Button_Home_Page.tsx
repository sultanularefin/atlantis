...
export interface Increment_Button_Home_Page_Props{
...
const Increment_Button_Home_Page: React.FC<Increment_Button_Home_Page_Props> = (
    {
        comp_Height_2,
        btn_Pressed,
        comp_Width,
...
// const Increment_Button_Home_Page= ()=>{
...
export default Increment_Button_Home_Page;
