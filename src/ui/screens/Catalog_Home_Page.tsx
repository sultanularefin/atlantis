...
import {
    ...
    ListRenderItem,
    VirtualizedList,
    BackHandler, StatusBarStyle, FlatList,
} from 'react-native';
...
import {useGetProductsQuery} from "../../appStore/features/products/productsApiSlice.ts";
import Focus_Aware_Status_Bar from "../header/Focus_Aware_Status_Bar.tsx";
import {ukbd_place_holder_TextColor} from "../ui_utils/important_Colors.ts";
   ...
   /* return (
    ...
    return (
        ...
        >
            ...
            <View style={{
                ...
                <FlatList
                    ...
                    */
                    ...
                    keyExtractor={(item: Doc, index) => `${index}${item.product_id}${item._id}`}
            ...
            {
                ((masterLoadingState || !Home__Data_Loaded_State) && (<Loading_Comp
