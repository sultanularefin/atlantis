...
const store_updated_total_cart_price_2 = (state: any, action: PayloadAction<number>) => {
...
export const product_Slice = createSlice({
    ...
    reducers: {
        ...
        add_price_to_total_cart_price: store_updated_total_cart_price_2,
    },
...
export const {
    ...
    store_updated_total_cart_price,
